...
public class Panel4_c : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        foreach(Transform go in buttons)
        {
            go.GetComponent<Button>().onClick.AddListener(delegate 
            {
                ...
                {
                    case "btn_Play":
                        Panel3_c._Instance.videoPlayer.Play();
                        break;
                    //case "btn_Previous":
                    //    break;
                    //case "btn_Next":
                    //    break;
                    case "btn_Stop":
                        Panel3_c._Instance.videoPlayer.Pause();
                        break;
                    //case "btn_Share":
                    //    break;
                    case "btn_Delete":
    ...
    public void DeleteVideo()
    {
        ...
        File.Delete(Panel3_c._Instance.videoPlayer.url);
